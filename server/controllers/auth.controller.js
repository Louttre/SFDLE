...
export const verifyEmail = async (req, res) => {
    ...
    try {
        ...
        // **Initialize UserAchievements for all achievements**
        const achievements = await AchievementModel.find();

        // Map over the achievements to create UserAchievement records
        ...
        // Insert the userAchievements into the database
        await UserAchievementModel.insertMany(userAchievements);
